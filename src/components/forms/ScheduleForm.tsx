...
export function ScheduleForm({
  ...
  const groupedAvailabilityFields: Record<
  ...
  > = availabilityFields
    ...
    .reduce((acc, availability) => {
      ...
      return acc;
    }, {} as Record<(typeof DAYS_OF_WEEK_IN_ORDER)[number], { id: string; dayOfWeek: string; startTime: string; endTime: string; index: number }[]>);
        ...
        <div className="flex gap-2 justify-end">
          <Button disabled={form.formState.isSubmitting} type="submit">
            {form.formState.isSubmitting ? (
              <Loader className="animate-spin size-full" />
            ) : (
              "Save"
            )}
          </Button>
